	 ...
	 try{
		 ...
		 if(con.isClosed())
		 ...
		 else
		   {
			 ...
			 %>
             <div>
	         <center><img src="../4000/images.jpg" class="ban_60_img"></center><br>
             </div>
			 ...
			 if(rs.next()){%>
             <div class="in_left">
             <center><img src="../4000/<%=product%>.jpg" class="imghover"><br>
			 ...
			 <span class="u"><%=rs.getString(7)%></span><br>
			  ...
			  <center>     
			  <img src="../4000/1/<%=product%>-1.jpg" class="imghover"></a><p><br>
			  <img src="../4000/1/<%=product%>-2.jpg" class="imghover"></a><p><br>
			  <img src="../4000/1/<%=product%>-3.jpg" class="imghover"></a><p>
			  </center>
		      <div class="in_br"><span></span></div>
