	 ...
	 try{
		 ...
		 if(con.isClosed())
		 ...
		 else
		   {
			 ...
			 sql="SELECT * FROM product WHERE product_id LIKE 'C%'";
			 ResultSet rs=con.createStatement().executeQuery(sql);
			 %>
			 <div>
	         <center><img src="../3000/8.png" class="ban_60_img"></center>
             </div>
	         ...
	         <div class="product_1">
		     <center><img src="../3000/<%=rs.getString(1)%>.jpg" class="imghover"><br>
			 <form action="C1.jsp" method="post">
