...
try{
	...
	try{
		...
		{%>
			<center><font size="5"><br><b>請選擇商品存在的位置</b></font>
			<form action="change_product2.jsp" method="post">
			<select name="option" style="font-size:20px;">
			<option value="1">已上架區
			<option value="2">未上架區
			</select>
			&nbsp <input type="submit" value="確定" style="font-size:16px;">
			</form></center><br><br>
		<%}
		con.close();		
	}
