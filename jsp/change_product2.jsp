...
<center><font size="6" color="#4876FF"><b>【修改產品】</b></font></center>	
...
try{
	...
	try{
		...
		else
		{
			...
			String sql2="SELECT* FROM wait_product";
			ResultSet rs=con.createStatement().executeQuery(sql);
			ResultSet rs2=con.createStatement().executeQuery(sql2);
			out.println("<center><font size='5'><br><b>請選擇想要修改的產品</b></font>");%>
			
			<form action="change_product3.jsp" method="post">
			...
			{
			%>
			<select size="1" name="choose2" style="font-size:20px;">
			<%	
			   while(rs2.next())
			   {
				out.println("<option name=choose value="+rs2.getString(1)+">"+rs2.getString(2));
			   } 
			%>
