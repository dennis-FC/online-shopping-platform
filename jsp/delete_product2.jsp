	 ...
	 try{
		 ...
		 if(con.isClosed())
		 ...
		 else
		  {
			 ...
			 String sql="DELETE FROM wait_product WHERE product_id='"+request.getParameter("product_id")+"'";
	
			 con.createStatement().execute(sql);
			 out.println("<br><br><br><div style='text-align:center;'><h1>產品刪除成功!! <a href='administrator.jsp'>點我回管理員專區</a></h1></div>");
