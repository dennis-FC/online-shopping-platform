	 ...
	 try{
		 ...
		 if(con.isClosed())
		 ...
		 else
		   {
			 ...
			 sql="SELECT * FROM product WHERE product_id LIKE 'E%'";
			 ResultSet rs=con.createStatement().executeQuery(sql);
			 %>
			 <div>
	         <center><img src="../5000/6.png" class="ban_60_img"></center>
             </div>
	         ...
	         <div class="product_1">
		     <center><img src="../5000/<%=rs.getString(1)%>.jpg" class="imghover"><br>
