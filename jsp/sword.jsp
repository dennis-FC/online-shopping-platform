	 ...
	 try{
		 ...
		 if(con.isClosed())
		 ...
		 else
		   {
			 ...
			 sql="SELECT * FROM product WHERE product_id LIKE 'A%'";
			 ResultSet rs=con.createStatement().executeQuery(sql);
			 %>
			 <div>
	         <center><img src="../1000/176.png" class="ban_60_img"></center>
             </div>
	         ...
	         <div class="product_1">
		     <center><img src="../1000/<%=rs.getString(1)%>.jpg" class="imghover"><br>
             ...
             <div class="product_2">
             <center><span><font color="blue"><span class="x"><%=rs.getString(2)%></font></span><br></center><p>
    	     <span class="h"><left><%=rs.getString(3)%></left></span><br>
