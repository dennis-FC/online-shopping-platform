	 ...
	 try{
		 ...
		 if(con.isClosed())
		 ...
		 else
		  {
			 ...
			 String sql="SELECT * FROM order_form WHERE buyer_id='"+session.getAttribute("username")+"'";
			 ...
			 else 
			 {
				...
				<a href="view_record.jsp"><input type="button" value="留言紀錄" class="btn5"></a>
			   	...
			   	<center><font size="6" color="#4876FF"><b>【消費紀錄】</font></center><br>
				 <center><table style="border:5px #4876FF groove" cellpadding="10" border='1' align="center" width="90%"></center>
				 <tr align="center">
				  <td width="80"><b><font size="4" color="#104E8B">訂單編號</td>
				  <td width="200"><b><font size="4" color="#104E8B">購買商品</td>
				  <td width="70"><b><font size="4" color="#104E8B">總金額</td>
				  <td width="100"><b><font size="4" color="#104E8B">配送方式</td>
				  <td width="100"><b><font size="4" color="#104E8B">付款方式</td>
				  <td width="100"><b><font size="4" color="#104E8B">優惠方案</td>
				  ...
				  <td width="100"><b><font size="4" color="#104E8B">時間</td>
				 </tr> 
