	 ...
	 try{
		 ...
		 if(con.isClosed())
		 ...
		 else
		  {
			 ...
			 String sql="SELECT * FROM product,view WHERE product.product_id=view.view_product && view_memberid='"+session.getAttribute("username")+"'";
			 ...
			 else 
			 {
				...
				<a href="view_record.jsp"><input type="button" value="留言紀錄" class="btn5"></a>
			   	...
			   	<center><font size="6" color="#4876FF"><b>【留言紀錄】</font></center><br>
